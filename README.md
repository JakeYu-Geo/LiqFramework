...
| File | Description |
|------|-------------|
| `SANISAND.m` | MATLAB implementation of the SANISAND model with the post‑liquefaction framework. |
| `HPIS_DEM.m` | MATLAB implementation of the HP+IS hypoplastic model with the post‑liquefaction framework. |
...
\[
\gamma_a \cdot g(\theta_\varepsilon) + \frac{\varepsilon_{\text{vmono}}}{\eta_\varepsilon} \geq \gamma_0
\]
...
## Model Validation (Section 4 of the Paper)
